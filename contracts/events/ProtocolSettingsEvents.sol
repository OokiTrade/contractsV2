...
contract ProtocolSettingsEvents {
  ...
  event SetLiquidationIncentivePercent(address indexed sender, address indexed loanToken, address indexed collateralToken, uint256 oldValue, uint256 newValue);
