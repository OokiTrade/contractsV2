...
contract GovernorBravoEvents {
  ...
  event QuorumPercentageSet(uint256 oldQuorumPercentage, uint256 newQuorumPercentage);
...
contract GovernorBravoDelegateStorageV1 is GovernorBravoDelegatorStorage {
  ...
  uint256 public proposalThresholdPercentage;
  ...
  mapping(uint256 => uint256) public quorumVotesForProposal;
