...
contract Constants {
  ...
  //IWeth public constant wethToken = IWeth(0xd0A1E359811322d97991E03f863a0C30C2cF029C); // kovan
  ...
  //IWeth public constant wethToken = IWeth(0x602C71e4DAC47a042Ee7f46E0aee17F94A3bA0B6); // local testnet only
  ...
  //IWeth public constant wethToken = IWeth(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // bsc (Wrapped BNB)
  ...
  // IWeth public constant wethToken = IWeth(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270); // polygon (Wrapped MATIC)
  ...
  //IWeth public constant wethToken = IWeth(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // avax (Wrapped AVAX)
