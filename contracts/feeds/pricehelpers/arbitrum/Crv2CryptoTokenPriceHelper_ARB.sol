...
contract Crv2CryptoTokenPriceHelper_ARB {
    ...
    address public constant CURVE_USDT_USDC_TOKEN = 0x7f90122BF0700F9E7e1F688fe926940E8839F353;
    ...
    function latestAnswer(address token) external view returns (uint256) {
        require(token == address(CURVE_USDT_USDC_TOKEN), "unsupported");
        ...
        return balanceUSD * ICurvePool(CURVE_USDT_USDC_TOKEN).get_virtual_price() * 1e2/ IERC20(CURVE_USDT_USDC_TOKEN).totalSupply();
    }
}
