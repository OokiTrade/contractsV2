...
contract LoanTokenFactory is PausableGuardian_0_8 {
  ...
  IBZx public constant PROTOCOL =
    IBZx(0x37407F3178ffE07a6cF5C847F8f680FEcf319FAB); // arbitrum
  // IBZx public constant PROTOCOL = IBZx(0xAcedbFd5Bc1fb0dDC948579d4195616c05E74Fd1); // optimism
  address public constant SIG_HELPER =
    0x888B54Ee4eD8D1B699F19F89146842147F16cA89; //Arbitrum
  ...
  ) internal pausable returns (address) {
