...
contract StakingConstantsV2 {
  ...
  address public constant OOKI_ETH_LP =
    0xEaaddE1E14C587a7Fb4Ba78eA78109BB32975f1e; // sushiswap
  ...
  uint256 internal constant vestingCliffTimestamp =
    vestingStartTimestamp + cliffDuration;
  uint256 internal constant vestingEndTimestamp =
  ...
  address internal constant SUSHI_MASTERCHEF =
  ...
  ICurveMinter public constant curveMinter =
    ICurveMinter(0xd061D61a4d941c39E5453435B6345Dc261C2fcE0);

  IBZRXv2Converter public constant CONVERTER =
    IBZRXv2Converter(0x6BE9B7406260B6B6db79a1D4997e7f8f5c9D7400);
