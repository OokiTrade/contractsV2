...
contract VoteDelegator is VoteDelegatorState, VoteDelegatorConstants, PausableGuardian_0_8 {
  ...
  function moveDelegatesByVotingBalance(uint256 votingBalanceBefore, uint256 votingBalanceAfter, address account) public {
    ...
    if (votingBalanceBefore > votingBalanceAfter) {
      _moveDelegates(currentDelegate, ZERO_ADDRESS, votingBalanceBefore - votingBalanceAfter);
    } else {
      _moveDelegates(ZERO_ADDRESS, currentDelegate, votingBalanceAfter - votingBalanceBefore);
    }
  }
