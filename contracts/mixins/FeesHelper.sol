...
contract FeesHelper is State, FeesEvents {
    ...
    {
        return
            feeTokenAmount.mul(tradingFeePercent).divCeil(
    ...
    {
        return
            feeTokenAmount.mul(borrowingFeePercent).divCeil(
                WEI_PERCENT_PRECISION
            );
    }
    ...
    function _payTradingFee(
        ...
        if (tradingFee != 0) {
            ...
            _payFeeReward(user, loanId, feeToken, tradingFee, FeeType.Trading);
        }
    }
    ...
    function _payFeeReward(
        ...
        if (rewardAmount != 0) {
            ...
            if (rewardAmount != 0) {
                protocolTokenHeld = tokenBalance.sub(rewardAmount);
