...
contract FeesHelper is State, ProtocolTokenUser, FeesEvents {
        ...
        internal
    {
        if (lendingFee != 0) {
            ...
            emit PayLendingFee(
             ...
             ///// NOTE: Lenders don't receive a fee reward /////
        }
    }

    // settles and pays borrowers based on the fees generated by their interest payments
    function _settleFeeRewardOnInterestExpense(
    ...
    function _payFeeReward(
        ...
        internal
    {
        uint256 rewardAmount = IPriceFeeds(priceFeeds).queryReturn(
            feeToken,
        ...
        if (rewardAmount != 0) {
            (address rewardToken, bool success) = _withdrawProtocolToken(
                user,
                rewardAmount
            );
            if (success) {
