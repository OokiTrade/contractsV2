...
def test_case1(accounts, Contract, interface, StakeVault, TestToken):
    ...
    #interface.IERC1155(StakeVault).balanceOf(StakeVault.convertToID(token_to_deposit, token_to_backstop), accounts[0])
    StakeVault.withdraw(token_to_deposit, token_to_backstop, 1e6, {"from":accounts[0]})
