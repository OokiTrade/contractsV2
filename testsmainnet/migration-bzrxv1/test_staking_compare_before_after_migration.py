...
def test_migration_staking_balances(requireMainnetFork, accounts, BZRX, OOKI, SLP, SUSHI_MASTERCHEF, SUSHI_FACTORY, WETH, interface, ADMIN_SETTINGS, TestToken, StakingV1_1, StakingProxy, BZRXv2Converter):
