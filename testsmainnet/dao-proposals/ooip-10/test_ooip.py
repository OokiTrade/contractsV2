...
APE.transfer(accounts[0], 10000e18, {'from': '0xa56cf001966d179751ba1c7fb5d137b4c5f344cc'})
APE.approve(iAPE, 2**256-1, {'from': accounts[0]})
iAPE.mint(accounts[0], 1000e18, {'from': accounts[0]})
...
USDT.transfer(accounts[0], 200e6, {'from': "0x61f2f664fec20a2fc1d55409cfc85e1baeb943e2"})
...
WETH.transfer(accounts[0], 1e18, {'from': "0x86fb84e92c1eedc245987d28a42e123202bd6701"})
...
iAPE.marginTrade(0, 2e18, 0, 1e18, LINK, accounts[0], b'',{'from': accounts[0]})
print("Trade APE/USDT")
iAPE.marginTrade(0, 2e18, 0, 1e6, USDT, accounts[0], b'',{'from': accounts[0]})
...
APE.approve(iUSDT, 2**256-1, {'from':accounts[0]})
iUSDT.marginTrade(0, 2e18, 0, 1e18, APE, accounts[0], b'',{'from': accounts[0]})