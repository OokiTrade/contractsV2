...
iUSDC.borrow(0, 1000e6, 90999999999, 1e18, ZERO_ADDRESS, accounts[0], accounts[0], b'', {"from": accounts[0], "value": Wei("1 ether")})

chain.mine(blocks=100)
holderUSDC = "0xcEe284F754E854890e311e3280b767F80797180d"
USDC.transfer(accounts[0], 20000e6, {"from": holderUSDC})
USDC.approve(BZX, 2**256-1, {"from": accounts[0]})

loans = BZX.getUserLoans(accounts[0], 0, 10, 0, 0, 0)
loanId = loans[0][0]
BZX.closeWithDeposit(loanId, accounts[0], 2000e6, b'', {"from": accounts[0]})
