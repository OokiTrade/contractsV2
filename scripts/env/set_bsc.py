...
SWEEP_FEES = Contract.from_abi("SWEEP_FEES", "0xC9726942C732fa048dC56f0DeBea7fB2c596bA8C", FeeExtractAndDistribute_BSC.abi)
...
class Deployment_Immutables:
    ...
    def VBZRX():
        return "0x0000000000000000000000000000000000000000"
    def OOKI():
        return "0xa5a6817ac4c164F27df3254B71fE83904B1C3c3e"
    def USDC():
