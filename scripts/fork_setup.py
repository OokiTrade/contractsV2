# This script is meant to setup contracts and global variables on a fork
import pytest
import time
from brownie import *
...
global iBZRX, BZRX, vBZRX, CURVE3POOL, CURVE3CRV, iUSDC
...
print("11")
# iUSDC -> allow to create a loan and test the user rewards claims in staking
