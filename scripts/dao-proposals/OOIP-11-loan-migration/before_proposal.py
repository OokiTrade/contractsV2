...
guardianImpl = Contract.from_abi("guardianImpl", address="0xce57167214f969db55190aac3d0d4732c2ba04b8", abi=ProtocolPausableGuardian.abi)
...
settingsImpl = Contract.from_abi("settingsImpl", address="0x307682d3cbc3f94345b8ba8f3168fd883d68af5c", abi=LoanSettings.abi)

# ## LoanOpenings
# openingsImpl = LoanOpenings.deploy({'from': deployer, "gas_price": gasPrice, "nonce": 191, "required_confs": 0})
openingsImpl = Contract.from_abi("openingsImpl", address="0x630178de9b510bde37c5e4cf1885e226d28a105c", abi=LoanOpenings.abi)
...
maintenace2Impl = Contract.from_abi("maintenace2Impl", address="0xaecad4373dc7fd95c37cb56446b8dd9dd1394811", abi=LoanMaintenance_2.abi)

# ## LoanMigration
# migrationImpl = LoanMigration.deploy({'from': deployer, "gas_price": gasPrice, "nonce": 192, "required_confs": 0})
migrationImpl = Contract.from_abi("maintenaceImpl", address="0x7899aec988f7ba3dec5088cd0a3e66836cf2b2b4", abi=LoanMigration.abi)

# # ## LoanMaintenance require mathTick
# maintenaceImpl = LoanMaintenance.deploy({'from': deployer, "gas_price": gasPrice, "nonce": 207, "required_confs": 0})
maintenaceImpl = Contract.from_abi("maintenaceImpl", address="0x6c75f3027c0e1f28af20adf487ff03cd05b8a1f3", abi=LoanMaintenance.abi)
# # 
# # ## LoanClosings
# closingImpl = LoanClosings.deploy({'from': deployer, "gas_price": gasPrice, "nonce": 208, "required_confs": 0})
closingImpl = Contract.from_abi("closingImpl", address="0x84c22684d3a901c2bae77f30deed3258817e737a", abi=LoanClosings.abi)
# # 
# ## SwapsExternal
...
protocolsettingsImpl = Contract.from_abi("ProtocolSettings", "0x46cdcc87fa0c65364f8dbb084201b8b0b56c2cf9", ProtocolSettings.abi)
...
dex_record = Contract.from_abi("DexRecords", "0x0d2cad590e0c2beb141ac872afd94fe17bec3bfb", DexRecords.abi)

# univ2 = SwapsImplUniswapV2_ETH.deploy({'from':deployer, "gas_price": gasPrice, "nonce": 196, "required_confs": 0})
univ2 = Contract.from_abi("SwapsImplUniswapV2_ETH", "0x2f9bbb09032ae0957d5d575fdf8dd2c5c7c2a721", SwapsImplUniswapV2_ETH.abi)

#  = SwapsImplUniswapV3_ETH.deploy({'from':deployer, "gas_price": gasPrice, "nonce": 197, "required_confs": 0})
univ3 = Contract.from_abi("SwapsImplUniswapV3_ETH", "0x1bffc51f229c6c51f9593f24728dc2271bb21d91", SwapsImplUniswapV3_ETH.abi)

# dex_record.setDexID(univ2.address, {'from':deployer, "gas_price": gasPrice, "nonce": 209, "required_confs": 0})
# dex_record.setDexID(univ3.address, {'from':deployer, "gas_price": gasPrice, "nonce": 210, "required_confs": 0})
# dex_record.transferOwnership(GUARDIAN_MULTISIG, {'from': deployer, "gas_price": gasPrice, "nonce": 211, "required_confs": 0})
...
CUI = Contract.from_abi("CurvedInterestRate", address="0x7fcea20c7136649fefde497eb3a207e7f401a4b8", abi=CurvedInterestRate.abi)

# # Deploy LoanTokenSettings
# settngs = LoanTokenSettings.deploy({'from': deployer, "gas_price": gasPrice, "nonce": 199, "required_confs": 0})
settngs = Contract.from_abi("settngs", address="0x40382c79aace65a5c12b7e6a6be899cc6b85db59", abi=LoanTokenSettings.abi)
...
settngsLowerAdmin = Contract.from_abi("settngsLowerAdmin", address="0x20aa8bb73b6eed3c48e485218c0293d1efa7efcc", abi=LoanTokenSettingsLowerAdmin.abi)

# loanTokenLogicStandard = LoanTokenLogicStandard.deploy({'from': deployer, "gas_price": gasPrice, "nonce": 201, "required_confs": 0})
loanTokenLogicStandard = Contract.from_abi("loanTokenLogicStandard", address="0x528d205b9521a5e5193b3da9be940c6a18d32a4d", abi=LoanTokenLogicStandard.abi)

# loanTokenLogicWeth = LoanTokenLogicWeth.deploy({'from': deployer, "gas_price": gasPrice, "nonce": 202, "required_confs": 0})
loanTokenLogicWeth = Contract.from_abi("LoanTokenLogicWeth", address="0x9b4dc5a53331c8d300ed75d84525d824d38c028a", abi=LoanTokenLogicWeth.abi)
