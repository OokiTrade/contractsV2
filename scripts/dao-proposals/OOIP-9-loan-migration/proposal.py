...
loanTokenLogicStandard = LoanTokenLogicStandard.deploy(TIMELOCK, {'from': deployer}).address
...
loanTokenLogicWeth = LoanTokenLogicWeth.deploy(TIMELOCK, {'from': deployer}).address
