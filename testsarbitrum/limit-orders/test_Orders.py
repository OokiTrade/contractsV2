...
def test_main():
    ...
    trades = orderbook.getActiveTrades(accounts[0])
    place_order_close(orderbook, trades[0], int(7.4e14))
...
def deploy_contracts():
    ...
    orderBookMarketOrders = OrderBookMarketOrders.deploy({'from':accounts[0]})
    ...
    orderbook.replaceContract(orderBookMarketOrders.address, {'from':orderbook.owner()})
