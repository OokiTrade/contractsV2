...
def testFarming_deposit(requireBscFork, tokens, tokenName, lpTokenName, pid, accounts, masterChef):
    #Precondition
    ...
    lpToken.approve(masterChef,depositAmount1, {'from': account1})
    lpToken.approve(masterChef,depositAmount2, {'from': account2})
...
def testFarming_withdraw(requireBscFork, tokens, tokenName, lpTokenName, pid, accounts, masterChef, bgovToken):
    ...
    #Test procedure
    masterChef.withdraw(pid,  depositAmount, {'from': account1})
